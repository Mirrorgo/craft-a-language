...
class Parser {
    ...
    parseStatement() {
        ...
        //根据'return'关键字，解析return语句
            ...
            t.code == scanner_1.Keyword.Super) {
            return this.parseExpressionStatement();
        }
   ...
   */
    ...
    parseClassDecl() {
        ...
        if (t.kind == scanner_1.TokenKind.Identifier) {
            ...
            this.addError("Expecting class name in ClassDecl, while we got a " + t.text, this.scanner.getLastPos());
            this.skip();
            isErrorNode = true;
        }
        let body;
        ...
        return new ast_1.ClassDecl(classToken, this.scanner.getLastPos(), t.text, body, isErrorNode);
    }
    parseClassBody() {
        let isErrorNode = false;
        let beginPos = this.scanner.getNextPos();
