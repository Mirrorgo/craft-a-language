...
import {Type, SysTypes, TypeUtil, ArrayType, FunctionType} from './types'
...
export class ClassDecl extends Decl{
    ...
    constructor(classToken:Token, endPos:Position,name:string, body:Block, isErrorNode:boolean = false){
