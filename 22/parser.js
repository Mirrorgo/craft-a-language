...
class Parser {
    ...
    parseStatement() {
        ...
        //根据'return'关键字，解析return语句
            ...
            t.kind == scanner_1.TokenKind.Keyword ||
            t.code == scanner_1.Keyword.True ||
            t.code == scanner_1.Keyword.False ||
            t.code == scanner_1.Keyword.Undefined ||
            t.code == scanner_1.Keyword.Null ||
