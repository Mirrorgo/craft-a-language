...
exports.Keyword = exports.Operators = exports.Op = exports.Seperator = exports.Scanner = exports.CharStream = exports.Token = exports.Position = exports.TokenKind = void 0;
//Token的类型
var TokenKind;
(function (TokenKind) {
    ...
    TokenKind[TokenKind["Seperator"] = 5] = "Seperator";
    TokenKind[TokenKind["Operator"] = 6] = "Operator";
...
Position.origion = new Position(0, 0, 0, 0); //占位符
// 代表一个Token的数据结构
class Token {
...
exports.Token = Token;
//一个占位符，用于解析出错后的Ast节点中。
Token.dumbToken = new Token(TokenKind.Identifier, "", new Position(0, 0, 0, 0));
/**
 * 一个字符串流。其操作为：
 * peek():预读下一个字符，但不移动指针；
 * next():读取下一个字符，并且移动指针；
...
(function (Keyword) {
    ...
    Keyword[Keyword["Void"] = 213] = "Void";
    Keyword[Keyword["Continue"] = 214] = "Continue";
    Keyword[Keyword["False"] = 215] = "False";
    Keyword[Keyword["Instanceof"] = 216] = "Instanceof";
    Keyword[Keyword["Throw"] = 217] = "Throw";
    Keyword[Keyword["While"] = 218] = "While";
    Keyword[Keyword["Debugger"] = 219] = "Debugger";
    Keyword[Keyword["Finally"] = 220] = "Finally";
    Keyword[Keyword["New"] = 221] = "New";
    Keyword[Keyword["True"] = 222] = "True";
    Keyword[Keyword["With"] = 223] = "With";
    Keyword[Keyword["Default"] = 224] = "Default";
    Keyword[Keyword["For"] = 225] = "For";
    Keyword[Keyword["Null"] = 226] = "Null";
    Keyword[Keyword["Try"] = 227] = "Try";
    Keyword[Keyword["Typeof"] = 228] = "Typeof";
    //下面这些用于严格模式
    Keyword[Keyword["Implements"] = 229] = "Implements";
    Keyword[Keyword["Let"] = 230] = "Let";
    Keyword[Keyword["Private"] = 231] = "Private";
    Keyword[Keyword["Public"] = 232] = "Public";
    Keyword[Keyword["Yield"] = 233] = "Yield";
    Keyword[Keyword["Interface"] = 234] = "Interface";
    Keyword[Keyword["Package"] = 235] = "Package";
    Keyword[Keyword["Protected"] = 236] = "Protected";
    Keyword[Keyword["Static"] = 237] = "Static";
    //more
    Keyword[Keyword["Any"] = 238] = "Any";
    Keyword[Keyword["String"] = 239] = "String";
    Keyword[Keyword["Number"] = 240] = "Number";
    Keyword[Keyword["Boolean"] = 241] = "Boolean";
    Keyword[Keyword["Symbol"] = 242] = "Symbol";
    //值
    Keyword[Keyword["Undefined"] = 243] = "Undefined";
    //面向对象
    Keyword[Keyword["Constructor"] = 244] = "Constructor";
    Keyword[Keyword["This"] = 245] = "This";
    Keyword[Keyword["Super"] = 246] = "Super";
    Keyword[Keyword["Extends"] = 247] = "Extends";
