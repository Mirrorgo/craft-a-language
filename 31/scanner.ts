...
export class Position{
    ...
    static origion = new Position(0,0,0,0);  //占位符
}
...
export class Token{
    ...
    static dumbToken = new Token(TokenKind.Identifier, "", new Position(0,0,0,0));
}
...
export class Scanner{
     ...
     * 目前只支持双引号，并且不支持转义。
     */
    private parseStringLiteral(quotationMark:'"'|"'"):Token{
        let pos = this.stream.getPosition();
