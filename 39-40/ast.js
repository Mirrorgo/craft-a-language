...
//     }
// }
class StmtWithScope extends Statement {
    constructor() {
        super(...arguments);
        this.scope = null; //该函数对应的Scope
    }
}
exports.StmtWithScope = StmtWithScope;
/////////////////////////////////////////////////////////////
//语句
/**
 * 函数声明节点
 */
class FunctionDecl extends StmtWithScope {
 ...
 * 函数体
 */
class Block extends StmtWithScope {
 ...
 * For语句
 */
class ForStatement extends StmtWithScope {
...
class AstVisitor {
    ...
    getEnclosingScope(node) {
        ...
        console_1.assert(parent, "getEnclosingScope()中，parent不应该是null");
