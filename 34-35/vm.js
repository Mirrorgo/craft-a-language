...
class BCModuleWriter {
    ...
    write(bcModule) {
        ...
        for (let t of this.types) {
            if (t.kind == types_1.TypeKind.Function) {
                bc1 = bc1.concat(this.writeFunctionType(t));
            }
            else if (t.kind == types_1.TypeKind.Named) {
                bc1 = bc1.concat(this.writeSimpleType(t));
            }
            else if (t.kind == types_1.TypeKind.Union) {
...
class BCModuleReader {
    ...
    readSimpleType(bc) {
        ...
        let t = new types_1.NamedType(typeName, []);
    ...
    buildTypes() {
        for (let typeName of this.typeInfos.keys()) {
            ...
            if (t.kind == types_1.TypeKind.Named) {
                let simpleType = t;
            ...
            else if (t.kind == types_1.TypeKind.Function) {
                let funtionType = t;
