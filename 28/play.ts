...
import {AstVisitor, AstNode, Block, Prog, VariableDecl, FunctionDecl, FunctionCall, Statement, Expression, ExpressionStatement, Binary, Unary, IntegerLiteral, DecimalLiteral, StringLiteral, Variable, ReturnStatement, IfStatement, ForStatement, AstDumper, IndexedExp, TypeOfExp} from './ast';
...
class Intepretor extends AstVisitor{   
     ...
     * @param value 
     */
    private setArrayElementValue(elementAddress:ArrayElementAddress, value:any):any{
    ...
    visitBinary(bi:Binary):any{
        ...
        switch(bi.op){
            ...
            case Op.Assign: //'='
                ...
                else if (v1 instanceof ArrayElementAddress){
