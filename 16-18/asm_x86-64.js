...
class Lower {
    ...
    // private saveCallerProtectedRegs(newInsts:Inst[]){
    //     for (let i = 0; i< this.usedCallerProtectedRegs.length; i++){
    //         let regIndex = Register.callerProtected32.indexOf(this.usedCallerProtectedRegs[i]);
    //         let reg64 = Register.callerProtected64[regIndex];
    //         newInsts.push(new Inst_1(OpCode.pushq, reg64));
    //     }
    // }
    // private restoreCallerProtectedRegs(newInsts:Inst[]){
    //     for (let i=this.usedCallerProtectedRegs.length-1; i>=0; i--){
    //         let regIndex = Register.callerProtected32.indexOf(this.usedCallerProtectedRegs[i]);
    //         let reg64 = Register.callerProtected64[regIndex];
