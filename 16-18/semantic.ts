...
import {AstVisitor, AstNode, Block, Prog, Decl, VariableDecl, FunctionDecl, FunctionCall, Statement, Expression, ExpressionStatement, Binary, IntegerLiteral, DecimalLiteral, StringLiteral, Variable, ReturnStatement, IfStatement, ForStatement, Unary, CallSignature, BooleanLiteral, NullLiteral} from './ast';
...
class LiveAnalyzer extends SemanticAstVisitor{ 
    ...
    visitFunctionDecl(functionDecl:FunctionDecl):any{
        ...
        if (functionType.returnType != SysTypes.Any && functionType.returnType != SysTypes.Void){
